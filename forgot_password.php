...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        if ($stmt->num_rows === 1) {
            ...
            // Send reset email
 // Send reset email
$resetLink = "http://tin.free.nf/reset_password.php?token=$token"; // Replace with your domain
...
try {
    ...
    <head>
        <style>
            ...
            .container { background-color: #ffffff; border-radius: 8px; padding: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); max-width: 600px; margin: auto; }
            h1 { color: #007bff; text-align: center; }
            .content { font-size: 16px; line-height: 1.5; }
            .reset-link { display: inline-block; background-color: #007bff; color: #fff; padding: 10px 20px; border-radius: 5px; text-decoration: none; }
...
<body>
    ...
    <a href="loginPage.php" class="back-link">
